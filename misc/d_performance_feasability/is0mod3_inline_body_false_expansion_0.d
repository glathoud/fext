module is0mod3_inline_body_false_expansion_0;

bool is0mod3_inline_body_false_expansion_0( int x )
{
 ...
 __fext_main_loop__: for (;;)
    {
      switch( __fext_case_i__)
        {
        case 0: is0mod3_fext(); continue __fext_main_loop__;

        case 1: is2mod3_fext(); continue __fext_main_loop__;

        case 2: is1mod3_fext(); continue __fext_main_loop__;
